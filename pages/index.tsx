...
const createEmbedSdkInstance = () => {
  ...
  const handleOnClickBuyAsset = async () => {
    ...
    const response = await fetch(`https://api.gatefi.com/onramp/v1/buy?amount=1000&crypto=ETH&fiat=MXN&orderCustomId=${randomString}&partnerAccountId=xxxxxx&payment=BANKCARD_MX&redirectUrl=https://www.google.com/&region=HK&walletAddress=0xc458f721D11322E36f781a9C58055de489178BF2`, {
        redirect: 'follow',
        headers: {
            "api-key": 'xxxxxx',
